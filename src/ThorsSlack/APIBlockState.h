...
struct RadioButtonsValue
{
    ...
    ThorsAnvil_VariantSerializerWithName(ThorsAnvil::Slack::BlockKit::RadioButtonsValue, radio_buttons);
    ThorsAnvil_TypeFieldName(type);
};
...
using InputValue = std::variant<CheckboxValue, DatePickerValue, DateTimePickerValue, EmailTextInputValue, NumberInputValue, PlainTextInputValue, RadioButtonsValue, /*RichTextInputValue,*/ StaticSelectValue, TimePickerValue, URLTextInputValue>;
